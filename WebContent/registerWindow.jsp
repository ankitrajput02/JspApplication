	...
	<form action="UserServlet" method="post">
		...
		<table>
			...
			<tr>
				...
				<td><input type="email" id="email" name="email" placeholder="abc@example.com" required><br></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="password" id="pswd" name="pswd" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
					title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"placeholder="Password" required><br></td>
			</tr>
			<tr>
				<td><label for="pswd1">Confirm Password:</label></td>
				<td><input type="password" id="pswd1" name="pswd1" placeholder="Confirm Password" required><br></td>
			</tr>
			<tr>
				<td></td>
				<td><input type="submit" id="btnSubmit" value="Submit" onclick="return Validate()" /></td>
